/*
 * File: src/app/(auth)/verification-sent/page.tsx
 * Verification Sent Page - Shows after successful registration
 */

import { Suspense } from "react";
import Link from "next/link";
import type { Metadata } from "next";
import VerificationSentForm from "@/components/auth/VerificationSentForm";
import { MindNamoLogo } from "@/components/Icons";
import FormSkeleton from "@/components/auth/FormSkeleton";

export const metadata: Metadata = {
  title: "Verification Sent | Mind Namo",
        ...
        <div className="relative z-20 mt-auto max-w-md">
          <blockquote className="space-y-4">
            <p className="text-2xl font-light italic leading-relaxed text-zinc-100">
              &ldquo;Check your inbox! We&apos;ve sent you a verification link to complete your registration and start your journey.&rdquo;
            </p>
